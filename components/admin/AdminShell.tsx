...
const NAV: NavItem[] = [
  ...
  { href: "/admin/contactos", label: "Contactos", icon: MessageCircle, permission: "contactos" },
  { href: "/admin/reclamaciones", label: "Reclamaciones", icon: ClipboardList, permission: "reclamaciones" },
  { href: "/admin/clientes", label: "Clientes", icon: Users, permission: "clientes" },
  { href: "/admin/inventario", label: "Almacenamiento", icon: Warehouse, permission: "inventario" },
  ...
  { href: "/admin/reportes", label: "Analítica", icon: BarChart3, permission: "reportes" },
