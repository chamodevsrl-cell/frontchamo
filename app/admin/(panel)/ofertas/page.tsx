  ...
  return (
    <div className="space-y-6">
      <p className="max-w-3xl text-sm text-brand-dark/70">
        Campañas y descuentos del catálogo público. El banner de abajo
        reemplaza el de <code>/ofertas</code> cuando tiene las 4 secciones
        completas; la lista de más abajo muestra lo que hoy se ve en esa
        página.
      </p>
