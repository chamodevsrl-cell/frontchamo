    ...
    <div className="flex min-h-full flex-1 flex-col bg-white dark:bg-brand-dark">
      ...
      <main className="mx-auto w-full max-w-[1600px] flex-1 px-4 py-12 sm:px-6 lg:px-8 xl:px-10">
        ...
        <p className="mt-3 max-w-xl text-brand-dark/70 dark:text-white/70">
          Usa el botón flotante de WhatsApp o escribe a ventas para una cotización
          mayorista sin compromiso.
        </p>
        <a
          href="https://wa.me/51999999999?text=Hola%2C%20quiero%20cotizar%20un%20pedido"
          target="_blank"
          rel="noopener noreferrer"
          className="mt-8 inline-flex rounded-lg bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#1ebe57]"
        >
