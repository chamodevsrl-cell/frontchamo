...
// TODO Backend: reemplazar con fetch(`/api/v1/catalog/${id}`) — ver API_CONTRACT_TIENDA.md §2.
 ...
 * TODO Backend: reemplazar con fetch(`/api/v1/catalog/${product.id}/related?limit=${limit}`)
