...
| `Preloader.tsx` | Carga inicial: logo oficial + engranaje girando + “CARGANDO...” |
| `IntroSplash.tsx` | Puertas al clic del logo; al entrar al carrito, un carrito que frena y sigue |
